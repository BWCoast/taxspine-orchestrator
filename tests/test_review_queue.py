    ...
    def test_unlinked_transfer_flag_propagated(self):
        ...
        with tempfile.TemporaryDirectory() as td:
            ...
            with patch("taxspine_orchestrator.storage.SqliteJobStore") as MockStore:
                ...
                mock_job.input.workspace_id = None
                mock_job.id = job_id
